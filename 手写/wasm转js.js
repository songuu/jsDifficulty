function _qdc() {
    ...
    h = function () {
      ...
      if (typeof t['navigator'] === 'undefined') {
        ...
        e['qdy'] =
          ...
          escape(t['navigator']['javaEnabled']['toString']())
            ? 'a'
            : 'i'
      }
  ...
  if (
    ...
    var aJ = null,
      ...
      aP,
      aQ = 720,
      aY = Uint8Array['prototype']['copyWithin']
        ? function (e, t, n) {
      ...
      b1 =
        typeof atob === 'function'
          ...
          : function (e) {
              ...
              do {
                ;(t =
                  (u['indexOf'](e['charAt'](f++)) << 2) |
                  ((a = u['indexOf'](e['charAt'](f++))) >> 4)),
                  (r =
                    ((15 & a) << 4) |
                    ((o = u['indexOf'](e['charAt'](f++))) >> 2)),
    ...
    var b7 = b6,
      b8 = (function (bK, bL, bM) {
            ...
            if (e >>> 0 < 245) {
              if (
                ...
                return (
                  ...
                  (0 | (f = 0 | bO[(l = (d + 8) | 0) >> 2])) == (0 | c)
                    ? (bO[3] = a & ~(1 << s))
                    : ((bO[(f + 12) >> 2] = c), (bO[u >> 2] = f)),
                  (f = s << 3),
                  (bO[(d + 4) >> 2] = 3 | f),
                  (bO[(s = (d + f + 4) | 0) >> 2] = 1 | bO[s >> 2]),
                  (c7 = t),
                  0 | l
                )
              }
              if (r >>> 0 > (l = 0 | bO[5]) >>> 0) {
                if (0 | o) {
                  return (
                    ...
                    (0 | (f = 0 | bO[(i = (o + 8) | 0) >> 2])) == (0 | u)
                      ? ((s = a & ~(1 << c)), (bO[3] = s), (h = s))
                      : ((bO[(f + 12) >> 2] = u), (bO[d >> 2] = f), (h = a)),
                    (c = ((f = c << 3) - r) | 0),
                    (bO[(o + 4) >> 2] = 3 | r),
                    (bO[((d = (o + r) | 0) + 4) >> 2] = 1 | c),
                    (bO[(o + f) >> 2] = c),
                    0 | l &&
                      ...
                      (u = (52 + (((o = l >>> 3) << 1) << 2)) | 0),
                      h & (s = 1 << o)
                        ? ((p = s = (u + 8) | 0), (_ = 0 | bO[s >> 2]))
                        : ((bO[3] = h | s), (p = (u + 8) | 0), (_ = u)),
                      (bO[p >> 2] = f),
                      (bO[(_ + 12) >> 2] = f),
                      (bO[(f + 8) >> 2] = _),
                      (bO[(f + 12) >> 2] = u)),
                  ...
                  if ((s = (f + r) | 0) >>> 0 > f >>> 0) {
                    ...
                    do {
                      if (0 | u) {
                        ...
                        ;(bO[(b + 24) >> 2] = u),
                          0 | (v = 0 | bO[(f + 16) >> 2]) &&
                            ((bO[(b + 16) >> 2] = v), (bO[(v + 24) >> 2] = b)),
                          0 | (v = 0 | bO[(f + 20) >> 2]) &&
                            ((bO[(b + 20) >> 2] = v), (bO[(v + 24) >> 2] = b))
                      }
                    } while (0)
                    return (
                      o >>> 0 < 16
                        ...
                        : ((bO[(f + 4) >> 2] = 3 | r),
                          ...
                          0 | l &&
                            ...
                            (v = (52 + (((u = l >>> 3) << 1) << 2)) | 0),
                            (y = 1 << u) & a
                              ? ((w = y = (v + 8) | 0), (A = 0 | bO[y >> 2]))
                              : ((bO[3] = y | a), (w = (v + 8) | 0), (A = v)),
                            (bO[w >> 2] = i),
                            (bO[(A + 12) >> 2] = i),
                            (bO[(i + 8) >> 2] = A),
                            (bO[(i + 12) >> 2] = v)),
                    ...
                    e: do {
                      if (Y >>> 0 < 16) {
                        ...
                        if (
                          ...
                          ;(y = (52 + ((s << 1) << 2)) | 0),
                            (u = 0 | bO[3]) & (o = 1 << s)
                              ? ((te = o = (y + 8) | 0), (ne = 0 | bO[o >> 2]))
                              : ((bO[3] = u | o), (te = (y + 8) | 0), (ne = y)),
                            (bO[te >> 2] = f),
                            (bO[(ne + 12) >> 2] = f),
                            (bO[(f + 8) >> 2] = ne),
                            (bO[(f + 12) >> 2] = y)
          ...
          if (
            (0 | bO[121]
              ...
              : ((bO[123] = 4096),
                ...
                (bO[126] = 0),
                (bO[114] = 0),
                (bO[121] = (-16 & n) ^ 1431655768),
                (oe = 4096)),
            (n = (E + 48) | 0),
            (oe = (ie = (oe + (G = (E + 47) | 0)) | 0) & (Y = (0 - oe) | 0)) >>>
              0 <=
              E >>> 0)
          ) {
            return (c7 = t), 0 | 0
              ...
              !(
                ...
                (1 ^
                  (le =
                    (fe = ((oe = 0 | ce(0)) - se) | 0) >>> 0 >
                    ((E + 40) | 0) >>> 0)) |
                (((se >>> 0 < oe >>> 0) & (-1 != (0 | se)) & (-1 != (0 | oe))) ^
                  1)
              ) &&
              ((ue = se), (de = le ? fe : he), (M = 145)),
            145 == (0 | M))
          ) {
            ;(he = ((0 | bO[111]) + de) | 0),
              (bO[111] = he),
              ...
              if (he) {
                  ...
                  t: do {
                    if ((0 | he) == (0 | oe)) {
                      ...
                      if (
                        ...
                        ;(Y = (52 + ((ie << 1) << 2)) | 0),
                          (ne = 0 | bO[3]) & (a = 1 << ie)
                            ? ((Te = a = (Y + 8) | 0), (Se = 0 | bO[a >> 2]))
                            : ((bO[3] = ne | a), (Te = (Y + 8) | 0), (Se = Y)),
                          (bO[Te >> 2] = fe),
                          (bO[(Se + 12) >> 2] = fe),
                          (bO[(fe + 8) >> 2] = Se),
                          (bO[(fe + 12) >> 2] = Y)
                ...
                if ((0 | fe) != (0 | he)) {
                  if (
                    ...
                    ;(le = (52 + ((Y << 1) << 2)) | 0),
                      (G = 0 | bO[3]) & (ie = 1 << Y)
                        ? ((Ee = ie = (le + 8) | 0), (De = 0 | bO[ie >> 2]))
                        : ((bO[3] = G | ie), (Ee = (le + 8) | 0), (De = le)),
                      (bO[Ee >> 2] = he),
                      (bO[(De + 12) >> 2] = he),
                      (bO[(he + 8) >> 2] = De),
                      (bO[(he + 12) >> 2] = le)
                  ...
                  t: do {
                    if (((-8 & bO[(re + 4) >> 2]) | 0) != (0 | n)) {
                      for (
                        le = n << (31 == (0 | Oe) ? 0 : (25 - (Oe >>> 1)) | 0),
                          ie = re;
                        (G =
                          0 |
                          bO[(Re = (ie + 16 + ((le >>> 31) << 2)) | 0) >> 2]);
            ...
            if (
              ...
              if (2 & n) {
                ...
                do {
                  ...
                  if (0 | k) {
                    ...
                    ;(bO[(T + 24) >> 2] = k),
                      0 | (s = 0 | bO[(y = (t + 16) | 0) >> 2]) &&
                        ((bO[(T + 16) >> 2] = s), (bO[(s + 24) >> 2] = T)),
                      0 | (s = 0 | bO[(y + 4) >> 2]) &&
                        ((bO[(T + 20) >> 2] = s), (bO[(s + 24) >> 2] = T))
                  }
                } while (0)
                if (
                  ((bO[(l + 4) >> 2] = 1 | v),
              ...
              if (((f = A >>> 3), A >>> 0 < 256)) {
                return (
                  (d = (52 + ((f << 1) << 2)) | 0),
                  (n = 0 | bO[3]) & (e = 1 << f)
                    ? ((E = e = (d + 8) | 0), (D = 0 | bO[e >> 2]))
                    : ((bO[3] = n | e), (E = (d + 8) | 0), (D = d)),
                  (bO[E >> 2] = l),
                  (bO[(D + 12) >> 2] = l),
                  (bO[(l + 8) >> 2] = D),
                  void (bO[(l + 12) >> 2] = d)
              ...
              e: do {
                if (D & n) {
                  ...
                  t: do {
                    if (((-8 & bO[(E + 4) >> 2]) | 0) != (0 | A)) {
                      for (
                        e = A << (31 == (0 | O) ? 0 : (25 - (O >>> 1)) | 0),
                          f = E;
                        (v =
                          0 | bO[(R = (f + 16 + ((e >>> 31) << 2)) | 0) >> 2]);
        ...
        var cn = {}
        return (
          (cn['___errno_location'] = cb),
          (cn['_bitshift64Shl'] = ci),
          (cn['_cmd5x'] = ca),
          (cn['_emscripten_get_sbrk_ptr'] = cj),
          (cn['_free'] = cd),
          (cn['_i64Add'] = ck),
          (cn['_malloc'] = cc),
          (cn['_memcpy'] = cl),
      ...
      if ((aM(aJ) || (aJ = v(aJ)), s || t)) {
        ...
        var bm = function (e) {
            e['byteLength'] && (e = new Uint8Array(e)),
              a9['set'](e, N),
              k['memoryInitializerRequest'] &&
                delete k['memoryInitializerRequest']['response'],
        ...
        if (bo) {
          ...
          if (k['memoryInitializerRequest']) {
            ...
            k['memoryInitializerRequest']['response']
              ? setTimeout(bp, 0)
              : k['memoryInitializerRequest']['addEventListener']('load', bp)
          } else {
            bn()
          }
        }
    ...
    switch (
      ...
      case 'i64':
        ;(aP = [
          ...
          +az(aO) >= 1
            ? aO > 0
              ? (0 | aC(+aB(aO / 4294967296), 4294967295)) >>> 0
              : ~~+aA((aO - +(~~aO >>> 0)) / 4294967296) >>> 0
            : 0),
        ]),
          (ac[e >> 2] = aP[0]),
          (ac[(e + 4) >> 2] = aP[1])
  ...
  function U(e) {
    var t = k['_' + e]
    return (
      T(t, 'Cannot call unknown function ' + e + ', make sure it is exported'),
      t
    )
  }
  ...
  function b2(e) {
    try {
      for (
        var t = b1(e), n = new Uint8Array(t['length']), r = 0;
        r < t['length'];
        ++r
      ) {
        n[r] = t['charCodeAt'](r)
