...
export type COLLAPSED_MENU_BTN_POSITION_TYPE =
  typeof COLLAPSED_MENU_BTN_POSITION
...
// role
export const SET_ROLE_SELECT_LIST = 'SET_ROLE_SELECT_LIST'
export type SET_ROLE_SELECT_LIST_TYPE = typeof SET_ROLE_SELECT_LIST
