      ...
      <uploader-list v-show="panelShow">
        <div class="file-panel" slot-scope="props" :class="{ collapse: collapse }">
          <div class="file-title">
            ...
            <div class="operate">
              <el-button @click="fileListShow" :icon="collapse ? 'el-icon-minus' : 'el-icon-plus'">
                {{collapse ? '展开' : '折叠'}}
              </el-button>
...
export default {
  ...
  methods: {
    ...
    onFileProgress (rootFile, file, chunk) {
      console.log(
        `上传中 ${file.name}，chunk：${chunk.startByte / 1024 / 1024} ~ ${chunk.endByte /
        1024 /
        1024}`
      );
    },
    ...
    /**
     * 计算md5，实现断点续传及秒传
     * 计算文件分片的大小，每次上传的文件需要记录上传的文件的md5编码
     * @param file
     */
    computeMD5 (file) {
